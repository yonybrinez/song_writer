...
const content = {
  en: {
    ...
    sections: [
      ...
      {
        heading: "Copying a song",
        body: "On any public song, click Copy to my songs. This creates a private copy in your account with the same content. You own the copy and can edit or publish it independently of the original.",
      },
      {
        heading: "Exporting",
      ...
      {
        heading: "Roles",
        body: "EDITOR (default): create and manage your own songs. ADMIN: everything an Editor can do, plus manage users and categories. VIEWER: read-only access, assigned manually by an Admin.",
      },
      {
        heading: "Admin panel",
  ...
  es: {
    ...
    sections: [
      ...
      {
        heading: "Copiar una canción",
        body: "En cualquier canción pública, haz clic en Copiar a mis canciones. Esto crea una copia privada en tu cuenta con el mismo contenido. Tú eres el propietario de la copia y puedes editarla o publicarla de forma independiente al original.",
      },
      {
        heading: "Exportar",
      ...
      {
        heading: "Roles",
        body: "EDITOR (por defecto): crear y gestionar tus propias canciones. ADMIN: todo lo que puede hacer un Editor, más gestionar usuarios y categorías. VIEWER: acceso de solo lectura, asignado manualmente por un Administrador.",
      },
      {
